...
An app's *config* is everything that is likely to vary between [deploys](codebase.html) (staging, production, developer environments, etc).  This includes:

* Resource handles to the database, Memcached, and other [backing services](backing-services.html)
